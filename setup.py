...
versioneer.VCS = 'git'
versioneer.versionfile_source = 'LconfPygmentsLexer/_version.py'
versioneer.versionfile_build = 'LconfPygmentsLexer/_version.py'
versioneer.tag_prefix = ''  # tags are like 1.1.0
versioneer.parentdir_prefix = 'LconfPygmentsLexer-'  # dirname like 'LconfPygmentsLexer-1.1.0'

_version = versioneer.get_version()

SCRIPT_PATH = dirname(abspath(getfile(currentframe())))
PACKAGE_NAME = 'LconfPygmentsLexer'
ROOT_PACKAGE_PATH = path_join(dirname(SCRIPT_PATH), PACKAGE_NAME)
MAIN_PACKAGE_PATH = path_join(ROOT_PACKAGE_PATH, PACKAGE_NAME)

from LconfPygmentsLexer import TESTED_HOST_OS

if sys_version_info[:2] < (3, 4) or sys_platform == 'win32':
   print(('''
\nLconfPygmentsLexer is only tested with Python 3.4.1 or higher:\n  current python version: {0:d}.{1:d}\n\n
...
entry_points = '''
[pygments.lexers]
lconflexer = LconfPygmentsLexer.lexer:LCONFLexer
'''
...
setup(
   ...
   url='https://github.com/peter1000/LconfPygmentsLexer',
   ...
   platforms=['Linux'],
   cmdclass=cmdclass,
   description="A simple pygments lexer for LCONF.",
