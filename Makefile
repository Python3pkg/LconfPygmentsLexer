...
PACKAGE = LconfPygmentsLexer

.PHONY: help clean_docs clean cleanall build_force install install_develop uninstall_develop dist pypi_all check_setup init_versioneer code_analysis_pylint
...
code_analysis_pylint:
	pylint -f colorized LconfPygmentsLexer
